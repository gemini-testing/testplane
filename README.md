...
- [Hermione](#hermione)
  ...
  - [CLI](#cli)
    ...
    - [Environment variables](#environment-variables)
      - [HERMIONE\_SKIP\_BROWSERS](#hermione_skip_browsers)
      - [HERMIONE\_SETS](#hermione_sets)
...
*Note, for browsers that support CDP (chrome and firefox nightly) there is no need to set `testsPerSession` to anything other than `Infinity`. This is because Hermione recreates browser contexts for each test in these browsers. Setting `testsPerSession` to anything other than `Infinity` will slow down the tests.*
