...
module.exports = class Browser {
    ...
    constructor(config, opts) {
        ...
        this._state = Object.assign(Object.assign({}, opts.state), { isBroken: false });
    }
            ...
            if (optName === "transformRequest") {
                options[optName] = req => {
                    ...
                    if (!req.headers["X-Request-ID"]) {
                        req.headers["X-Request-ID"] = `${this.state.testXReqId}${X_REQUEST_ID_DELIMITER}${crypto.randomUUID()}`;
                    }
                    return req;
                };
            }
