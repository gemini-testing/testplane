...
module.exports = class ExistingBrowser extends Browser {
    ...
    _attachSession({ sessionId, sessionCaps, sessionOpts = {} }) {
        ...
        const opts = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ sessionId }, sessionOpts), this._getSessionOptsFromConfig(OPTIONAL_SESSION_OPTS)), detectedSessionEnvFlags), this._config.sessionEnvFlags), { options: _.pick(sessionOpts, "automationProtocol"), capabilities: Object.assign(Object.assign({}, sessionOpts.capabilities), sessionCaps), requestedCapabilities: sessionOpts.capabilities });
        return webdriverio.attach(opts);
    }
    _initMeta() {
        return Object.assign({ pid: process.pid, browserVersion: this.version, testXReqId: this.state.testXReqId }, this._config.meta);
    }
    _takeScreenshot() {
    ...
    async _performIsolation({ sessionCaps, sessionOpts }) {
        ...
        if (!isSupportIsolation(browserName, browserVersion)) {
            logger.warn(`WARN: test isolation works only with chrome@${MIN_CHROME_VERSION_SUPPORT_ISOLATION} and higher, ` +
