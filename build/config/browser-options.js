...
function buildBrowserOptions(defaultFactory, extra) {
    ...
    return _.extend(extra, {
        ...
        takeScreenshotOnFails: option({
            ...
            map: (value, config) => (Object.assign(Object.assign({}, defaultFactory("takeScreenshotOnFails")(config)), value)),
        }),
        ...
        assertViewOpts: option({
            ...
            map: value => {
                return value === defaults.assertViewOpts ? value : Object.assign(Object.assign({}, defaults.assertViewOpts), value);
            },
        }),
