...
module.exports = browser => {
    ...
    const assertView = async (state, selectors, opts) => {
        ...
        const handleCaptureProcessorError = e => e instanceof BaseStateError ? hermioneCtx.assertViewResults.add(e) : Promise.reject(e);
        ...
        const { equal, diffBounds, diffClusters, diffImage, metaInfo = {}, } = await Image.compare(refBuffer, currBuffer, imageCompareOpts);
