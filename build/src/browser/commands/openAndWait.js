...
const is = {
    ...
    font: match => lodash_1.default.isString(match.request.url) && [".ttf", ".woff", ".woff2"].some(ext => match.request.url.endsWith(ext)),
    favicon: match => lodash_1.default.isString(match.request.url) && match.request.url.endsWith("/favicon.ico"),
};
