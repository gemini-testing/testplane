...
exports.default = (browser) => {
    ...
    session.addCommand("switchToRepl", async function (ctx = {}) {
        ...
        if (onReplMode) {
            logger_1.default.warn(chalk_1.default.yellow("Testplane is already in REPL mode"));
            return;
        }
        logger_1.default.log(chalk_1.default.yellow("You have entered to REPL mode via terminal (test execution timeout is disabled)."));
