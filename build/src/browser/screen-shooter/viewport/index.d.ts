...
declare class Viewport {
    ...
    validate(browser: any): true | import("./coord-validator/errors/height-viewport-error").HeightViewportError | import("./coord-validator/errors/offset-viewport-error").OffsetViewportError | undefined;
