...
exports.run = () => {
    ...
    program
        ...
        .action(async (paths) => {
        try {
            const { reporter: reporters, browser: browsers, set: sets, grep, updateRefs, require: requireModules, inspect, inspectBrk, repl, replBeforeTest, replOnFail, devtools, } = program;
