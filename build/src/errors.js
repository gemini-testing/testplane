...
const testplane_internal_error_1 = require("./errors/testplane-internal-error");
...
const Errors = {
    ...
    TestplaneInternalError: testplane_internal_error_1.TestplaneInternalError,
    AbortOnReconnectError: abort_on_reconnect_error_1.AbortOnReconnectError,
};
