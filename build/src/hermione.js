...
class Hermione extends base_hermione_1.BaseHermione {
    ...
    async run(testPaths, { browsers, sets, grep, updateRefs, requireModules, inspectMode, reporters = [] } = {}) {
        ...
        runtime_config_1.default.getInstance().extend({ updateRefs, requireModules, inspectMode });
        ...
        await this._init();
        runner.init();
        await runner.run(await this._readTests(testPaths, { browsers, sets, grep }), stats_1.Stats.create(this));
