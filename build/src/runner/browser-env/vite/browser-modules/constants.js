...
export const ASYMMETRIC_MATCHER = typeof Symbol === "function" && Symbol.for ? Symbol.for("jest.asymmetricMatcher") : 1267621;
export const CONSOLE_METHODS = ["log", "info", "warn", "error", "debug", "table"];
