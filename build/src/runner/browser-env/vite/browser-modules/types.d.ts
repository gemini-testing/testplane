...
import type { ChainablePromiseElement, ElementArray } from "@testplane/webdriverio";
...
export interface BrowserRunExpectMatcherPayload {
    ...
    context?: WebdriverIO.Browser | WebdriverIO.Element | ElementArray | ChainablePromiseElement;
}
