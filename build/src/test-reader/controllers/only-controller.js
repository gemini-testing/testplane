...
exports.OnlyController = OnlyController;
_OnlyController_eventBus = new WeakMap(), _OnlyController_instances = new WeakSet(), _OnlyController_addTrap = function _OnlyController_addTrap(match) {
    __classPrivateFieldGet(this, _OnlyController_eventBus, "f").emit(events_1.TestReaderEvents.NEW_BUILD_INSTRUCTION, ({ treeBuilder }) => {
