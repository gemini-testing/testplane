    ...
    try {
                ...
                if (!isSilent) {
                    if (err.code === "MODULE_NOT_FOUND") {
                        ...
                        if (isSwcDebugLogEnabled) {
                            ...
                            logger.warn(`testplane: could not load @swc/core. Run Testplane with "DEBUG=testplane:swc" to see details.`);
                        }
                    }
                }
            }
        ...
        try {
            ...
            if (!isSilent) {
                ...
                logger.warn(`testplane: an error occured while trying to register ts-node (${params}). TypeScript tests won't be read:`, err);
            }
        }
    }
