...
const validateUnknownBrowsers = (browsers, configBrowsers) => {
    ...
    logger.warn((0, util_1.format)("%s Unknown browser ids: %s. Use one of the browser ids specified in the config file: %s", chalk_1.default.yellow("WARNING:"), unknownBrowsers.join(", "), configBrowsers.join(", ")));
};
