...
module.exports = class Stats {
    ...
    constructor(runner) {
        this._events = [];
        const pushEvent_ = group => ({ id, browserId }) => this._events.push({ group, id, browserId });
        runner &&
            runner
    ...
    getResult() {
        ...
        const statsByBrowser = _(this._events)
            ...
            return Object.assign(Object.assign(Object.assign({}, emptyStat), stats), { total: _.uniqBy(events, "id").length });
        })
            .value();
        const overall = _.mergeWith(emptyStat, ...Object.values(statsByBrowser), (a, b) => a + b);
        return Object.assign(Object.assign({}, overall), { perBrowser: statsByBrowser });
    }
};
