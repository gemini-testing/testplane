...
_TestParser_buildInstructions = new WeakMap(), _TestParser_instances = new WeakSet(), _TestParser_applyInstructionsEvents = function _TestParser_applyInstructionsEvents(eventBus) {
    ...
    eventBus
        ...
        .on(ReadEvents.NEW_BUILD_INSTRUCTION, instruction => __classPrivateFieldGet(this, _TestParser_buildInstructions, "f").push(instruction, currentFile));
    ...
    const passthroughEvent_ = (event, customOpts = {}) => {
        eventBus.on(event, data => this.emit(event, Object.assign(Object.assign(Object.assign({}, data), { hermione }), customOpts)));
    };
