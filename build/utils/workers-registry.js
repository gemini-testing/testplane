...
module.exports = class WorkersRegistry extends EventEmitter {
    ...
    _createWorkerFarm() {
        ...
        const params = Object.assign({ maxConcurrentWorkers: this._config.system.workers, maxCallsPerWorker: this._config.system.testsPerWorker, maxConcurrentCallsPerWorker: Infinity, autoStart: true, maxRetries: 0, onChild: child => this._initChild(child) }, this._inspectParams());
