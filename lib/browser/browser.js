...
module.exports = class Browser {
    ...
    _saveCurrentWindowSize() {
        if (this.windowSize) {
            return this.applyState({originWindowSize: this.windowSize});
        }
        ...
        return this._session
            ...
            .then((windowInfo) => {
                if (windowInfo.value) {
                    ...
                    this.applyState({originWindowSize: {width, height}});
                }
            });
    }
    ...
    get windowSize() {
        return this._config.windowSize || this.state.originWindowSize;
    }
