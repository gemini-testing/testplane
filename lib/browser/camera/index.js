...
module.exports = class Camera {
    ...
    _cropAreaToViewport(imageArea, page) {
        ...
        return {
            left: Math.floor((imageArea.left + cropArea.left) * page.pixelRatio),
            top: Math.floor((imageArea.top + cropArea.top) * page.pixelRatio),
            width: Math.ceil(Math.min(imageArea.width - cropArea.left, cropArea.width) * page.pixelRatio),
            height: Math.ceil(Math.min(imageArea.height - cropArea.top, cropArea.height) * page.pixelRatio)
        };
    }
};
