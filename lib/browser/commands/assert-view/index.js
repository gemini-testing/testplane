...
module.exports = (browser) => {
    ...
    session.addCommand('assertView', async (state, selectors, opts = {}) => {
        opts = _.defaults(opts, {ignoreElements: [], tolerance, allowViewportOverflow: false});
        ...
        const currImgInst = await screenShooter.capture(page, {allowViewportOverflow: opts.allowViewportOverflow});
