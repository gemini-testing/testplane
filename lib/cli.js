...
const validateBrowsers = require('./validators').validateBrowsers;
...
`  Overriding config
    ...
    Examples:
      ...
      hermione_browsers-firefox-sessions-per-browser 10 hermione
...
const logRunData = (config) => {
    ...
    logger.log('  gridUrl: %s', config.gridUrl);
