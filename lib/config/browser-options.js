...
const nonNegativeIntegerOption = util.nonNegativeIntegerOption;
...
function buildBrowserOptions(defaultFactory, extra) {
    return _.extend(extra, {
        ...
        httpTimeout: nonNegativeIntegerOption(defaultFactory('httpTimeout')),
        ...
        retry: nonNegativeIntegerOption(defaultFactory('retry')),
