...
module.exports = inherit({
    ...
    _onTestFail: function(test) {
        ...
        var testErr = test.err || {},
            // TODO: remove this hack after https://st.yandex-team.ru/FEI-1567
            errorMsg = (testErr.stack && !/^undefined/.test(testErr.stack))
                ? testErr.stack
                : testErr;
        logger.log(chalk.red(errorMsg));
    },
