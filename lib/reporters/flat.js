...
module.exports = inherit({
    __constructor: function() {
        this._passed = this._failed = this._skipped = this._pending = 0;
    },
    ...
    _onTestFail: function(test) {
        ...
        logger.log(chalk.red(test.error && test.error.stack || test.error));
    },
    ...
    _onRunnerEnd: function() {
        ...
        logger.log('Total: %s Passed: %s Failed: %s Skipped: %s Pending: %s',
