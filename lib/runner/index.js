...
module.exports = class MainRunner extends AsyncEmitter {
    ...
    run(sourcesByBro) {
        ...
        return this.emitAndWait(RunnerEvents.RUNNER_START, this)
            .then(() => {
                const mochaRunners = this._initMochaRunners(sourcesByBro);
    ...
    _initMochaRunners(sourcesByBro) {
        return _.mapValues(sourcesByBro, (sources, browserId) => this._createMochaRunner(browserId).init(sources));
    }
