...
const ParserEvents = require('../../test-reader/parser-events');
const TestParserAPI = require('../../test-reader/test-parser-api');
const Skip = require('../../test-reader/skip');
const SkipBuilder = require('../../test-reader/skip/skip-builder');
const OnlyBuilder = require('../../test-reader/skip/only-builder');
...
module.exports = class MochaAdapter extends EventEmitter {
    ...
    _passthroughFileEvents(emit) {
        const emit_ = (event, opts) => emit(event, {
            suite: this.suite,
