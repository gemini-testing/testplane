...
module.exports = class HookRunner {
    ...
    _hasBeforeEachHooks(suite) {
        return suite && (suite.beforeEachHooks.length || this._hasBeforeEachHooks(suite.parent));
    }
    ...
    _hasAfterEachHooks(suite) {
        return suite && (suite.afterEachHooks.length || this._hasAfterEachHooks(suite.parent));
    }
