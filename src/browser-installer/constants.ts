...
export const CHROME_FOR_TESTING_MILESTONES_FILENAME = "latest-versions-per-milestone.json";
export const CHROME_FOR_TESTING_PATCH_VERSIONS_FILENAME = "latest-patch-versions-per-build.json";
export const CHROME_FOR_TESTING_LATEST_RELEASE_FILENAME_PREFIX = "LATEST_RELEASE_";
export const CHROME_FOR_TESTING_MILESTONES_API_URL = `${CHROME_FOR_TESTING_VERSIONS_API_URL}/${CHROME_FOR_TESTING_MILESTONES_FILENAME}`;
export const CHROME_FOR_TESTING_LATEST_STABLE_API_URL = `${CHROME_FOR_TESTING_VERSIONS_API_URL}/${CHROME_FOR_TESTING_LATEST_RELEASE_FILENAME_PREFIX}STABLE`;
...
export const FIREFOX_VERSIONS_LATEST_VERSIONS_FILENAME = "firefox_versions.json";
export const FIREFOX_VERSIONS_ALL_VERSIONS_API_URL = `${FIREFOX_VERSIONS_VERSIONS_API_URL}/firefox.json`;
export const FIREFOX_VERSIONS_LATEST_VERSIONS_API_URL = `${FIREFOX_VERSIONS_VERSIONS_API_URL}/${FIREFOX_VERSIONS_LATEST_VERSIONS_FILENAME}`;
...
export const DRIVER_WAIT_INTERVAL = 25; // 25ms
