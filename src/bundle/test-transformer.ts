        ...
        visitor: {
            ImportDeclaration(path: NodePath<ImportDeclaration>): void {
                ...
                try {
                    ...
                    if (shouldIgnoreImportFromStyleFile(err as Error)) {
                        path.remove();
                        return;
                    }
...
function shouldIgnoreImportFromStyleFile(err: Error): boolean {
...
/*
Generates Proxy expression with passed arguments:
`new Proxy(args)`
*/
