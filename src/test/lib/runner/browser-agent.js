...
describe('runner/browser-agent', () => {
    ...
    describe('getBrowser', () => {
        ...
        it('should request browser with passed options', async () => {
            ...
            assert.calledOnceWith(BrowserPool.prototype.getBrowser, sinon.match.any, {foo: 'bar', version: '100.500'});
        });
        ...
        it('should request other browser if got same session', async () => {
            ...
            BrowserPool.prototype.getBrowser
                .onFirstCall().resolves(broFoo)
                .onSecondCall().resolves(broBar);
        ...
        it('should always request browser with passed options', async () => {
            BrowserPool.prototype.getBrowser
                .onCall(0).resolves(mkBrowser_({sessionId: 'foo'}))
                .onCall(1).resolves(mkBrowser_({sessionId: 'foo'}))
                .onCall(2).resolves(mkBrowser_({sessionId: 'bar'}));
