...
const {UPDATE_REFERENCE} = require('build/worker/constants/runner-events');
const {handleNoRefImage, handleImageDiff} = require('build/browser/commands/assert-view/capture-processors/update-refs');
