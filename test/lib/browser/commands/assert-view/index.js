...
const clientBridge = require('build/core/client-bridge');
const Image = require('build/core/image');
const ScreenShooter = require('build/core/screen-shooter');
...
const updateRefs = require('build/browser/commands/assert-view/capture-processors/update-refs');
