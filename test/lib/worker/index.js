...
const HermioneFacade = require('build/worker/hermione-facade');
...
describe('worker', () => {
    ...
    beforeEach(() => {
        ...
        clearRequire(require.resolve('build/worker'));
    });
    ...
    describe('runTest', () => {
        ...
        beforeEach(() => {
            ...
            const worker = require('build/worker');
        ...
        it('should delegate runTest call to hermione facade', () => {
            ...
            return runTest('fullTitle', {some: 'opts'})
                .then((res) => assert.deepEqual(res, {foo: 'bar'}));
        });
