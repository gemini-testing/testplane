...
describe('"CDPConnection"', () => {
    ...
    describe("request handling", () => {
        ...
        it("should send request and receive successful response", async () => {
            const response = await connection.request<unknown>("Successfull.Method", { params: { test: "value" } });

            assert.deepEqual(response, { id: 1, params: { test: "value" } });
        });

        it("should handle CDP error response", async () => {
            const requestPromise = connection.request("Unsuccessfull.Method", {
        ...
        it("should generate unique request IDs", async () => {
            const promise1 = connection.request<unknown>("Successfull.Method", { params: { test: "1" } });
            const promise2 = connection.request<unknown>("Successfull.Method", { params: { test: "2" } });
        ...
        it("should handle request with sessionId", async () => {
            const result = await connection.request<unknown>("Successfull.Method", {
    ...
    describe("connection establishment and retries", () => {
        ...
        it("should establish connection successfully", async () => {
            ...
            const result = await connection.request<unknown>("Successfull.Method", { params: { test: "value" } });
        ...
        it("should connect once on multiple requests", async () => {
            const [r1, r2, r3] = await Promise.all([
                connection.request<unknown>("Successfull.Method"),
                connection.request<unknown>("Successfull.Method"),
                connection.request<unknown>("Successfull.Method"),
            ]);
    ...
    describe("event handling", () => {
        ...
        beforeEach(async () => {
            ...
            await connection.request("Successfull.Method"); // Establishes connection
        ...
        it("should forward CDP events to event handler", async () => {
            ...
            await connection.request("Successfull.Method");
        ...
        it("should handle malformed JSON messages", async () => {
            ...
            const result = await connection.request<unknown>("Successfull.Method", { params: {} });
        ...
        it("should retry + handle malformed response with extractable request ID", async () => {
            ...
            const requestPromise = connection.request("Successfull.Method");
    ...
    describe("connection management and reconnection", () => {
        ...
        it("should reuse existing connection for multiple requests", async () => {
            const promise1 = connection.request<unknown>("Successfull.Method");
            const promise2 = connection.request<unknown>("Successfull.Method");
        ...
        it("should handle connection drop and reconnect", async () => {
            const result1 = await connection.request<unknown>("Successfull.Method");
            assert.deepEqual(result1, { id: 1 });
            ...
            const result2 = await connection.request<unknown>("Successfull.Method");
