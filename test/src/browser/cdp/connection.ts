...
describe('"CDPConnection"', () => {
    ...
    describe("request handling", () => {
        ...
        it("should send request and receive successful response", async () => {
            const response = await connection.request("Successfull.Method", { params: { test: "value" } });
        ...
        it("should generate unique request IDs", async () => {
            const promise1 = connection.request("Successfull.Method", { params: { test: "1" } });
            const promise2 = connection.request("Successfull.Method", { params: { test: "2" } });
        ...
        it("should handle request with sessionId", async () => {
            const result = await connection.request("Successfull.Method", {
    ...
    describe("connection establishment and retries", () => {
        ...
        it("should establish connection successfully", async () => {
            ...
            const result = await connection.request("Successfull.Method", { params: { test: "value" } });
        ...
        it("should connect once on multiple requests", async () => {
            const [r1, r2, r3] = await Promise.all([
                connection.request("Successfull.Method"),
                connection.request("Successfull.Method"),
                connection.request("Successfull.Method"),
            ]);
    ...
    describe("event handling", () => {
        ...
        it("should handle malformed JSON messages", async () => {
            ...
            const result = await connection.request("Successfull.Method", { params: {} });
    ...
    describe("connection management and reconnection", () => {
        ...
        it("should reuse existing connection for multiple requests", async () => {
            const promise1 = connection.request("Successfull.Method");
            const promise2 = connection.request("Successfull.Method");
        ...
        it("should handle connection drop and reconnect", async () => {
            ...
            const result2 = await connection.request("Successfull.Method");
