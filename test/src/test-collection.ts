...
describe("test-collection", () => {
    ...
    describe("eachTestByVersions", () => {
        it("should iterate by columns over tests", () => {
            ...
            collection.eachTestByVersions("bro", (test, browserId, browserVersion) =>
    ...
    describe("enableTest", () => {
        it("should do nothing for tests which were not disabled", () => {
            ...
            collection.enableTest("foo bar").enableTest("baz qux");
        ...
        it("should enable test in all browsers", () => {
            ...
            collection.disableAll().enableTest("foo bar");
        ...
        it("should enable previously disabled single test", () => {
            ...
            collection.disableTest("foo bar").enableTest("foo bar");
        ...
        it("should enable test even if it was disabled twice", () => {
            ...
            collection.disableTest("foo bar").disableTest("foo bar").enableTest("foo bar");
        ...
        it("should enable test in specified browser", () => {
            ...
            collection.disableAll().enableTest("foo bar", "bro1");
