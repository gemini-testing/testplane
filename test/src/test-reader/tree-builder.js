...
describe("test-reader/tree-builder", () => {
    ...
    describe("addSuite", () => {
        ...
        it("should set first passed suite as root suite", () => {
            ...
            const builder = new TreeBuilder().addSuite(suiteFoo).addSuite(suiteBar);
        ...
        it("should link suite with its parent", () => {
            ...
            new TreeBuilder().addSuite(childSuite, parentSuite);
        ...
        it("should apply traps for suite", () => {
            ...
            new TreeBuilder().addTrap(trapFoo).addTrap(trapBar).addSuite(suite);
        ...
        it("should apply traps only once", () => {
            ...
            new TreeBuilder().addTrap(trapFoo).addTrap(trapBar).addSuite(new Suite({})).addSuite(new Suite({}));
        ...
        it("should apply traps after linking with parent", () => {
            ...
            new TreeBuilder().addTrap(trapFoo).addSuite(new Suite({}), new Suite({}));
    ...
    describe("addTest", () => {
        ...
        it("should link test with its parent", () => {
            ...
            new TreeBuilder().addTest(test, suite);
        ...
        it("should apply traps for test", () => {
            ...
            new TreeBuilder().addTrap(trapFoo).addTrap(trapBar).addTest(test, new Suite({}));
        ...
        it("should apply traps after linking with parent", () => {
            ...
            new TreeBuilder().addTrap(trapFoo).addTest(new Test({}), new Suite({}));
    ...
    describe("addBeforeEachHook", () => {
        ...
        it("should link hook with its parent", () => {
            ...
            new TreeBuilder().addBeforeEachHook(hook, suite);
        ...
        it("should not apply traps for hook", () => {
            ...
            new TreeBuilder().addTrap(trap).addBeforeEachHook(new Hook({}), new Suite({}));
    ...
    describe("addAfterEachHook", () => {
        ...
        it("should link hook with its parent", () => {
            ...
            new TreeBuilder().addAfterEachHook(hook, suite);
        ...
        it("should not apply traps for hook", () => {
            ...
            new TreeBuilder().addTrap(trap).addAfterEachHook(new Hook({}), new Suite({}));
    ...
    describe("addTestFilter", () => {
        ...
        it("should not apply filter on site", () => {
            new TreeBuilder().addSuite(new Suite()).addTestFilter(() => true);
    ...
    describe("applyFilters", () => {
        ...
        it("should not process tests if no any suite added", () => {
            new TreeBuilder().addTestFilter(() => true).applyFilters();

            assert.notCalled(Suite.prototype.filterTests);
        });

        it("should not process tests if no filter added", () => {
            new TreeBuilder().addSuite(new Suite()).applyFilters();
